...

{
  ...
  environment = {
    systemPackages = with pkgs; [
      ...
      wget curl openssl git appimage-run duf ncdu fzf tmux
      kitty hyprpaper mako kdePackages.dolphin imv mpv mpd mpc ncmpcpp
      grim slurp wl-clipboard cliphist psmisc maple-mono.NF-CN
      nginx cockpit firefox flatpak
  ...
  services.cockpit = {
    ...
    port = 9090;
    openFirewall = true;
    settings.WebService.Protocol = "tls";
  };
