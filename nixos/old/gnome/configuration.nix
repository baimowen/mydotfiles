...

{
  ...
  # services.gnome.core-utilities.enable = false;  # old version
  ...
  environment.systemPackages = with pkgs; [
    ...
    duf ncdu fzf tmux ghostty
    # nginx cockpit
    firefox flatpak
    gnome-control-center gnome-tweaks dconf-editor gnome-extension-manager
    gnome-text-editor nautilus nautilus-python baobab file-roller menulibre
    gnome-clocks gnome-calculator gnome-software
